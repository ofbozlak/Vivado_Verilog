...
HD_PWD='D:/BELGELER/PROJERLER/VVADO/VERLOG/bit_4toplayici/bit_4toplayici.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bit_4adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bit_4adder.tcl
